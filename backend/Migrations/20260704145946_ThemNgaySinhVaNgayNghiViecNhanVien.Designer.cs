...
namespace PharmacyManagement.Api.Migrations
{
    ...
    [Migration("20260704145946_ThemNgaySinhVaNgayNghiViecNhanVien")]
    partial class ThemNgaySinhVaNgayNghiViecNhanVien
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Medicine", b =>
                {
                    ...
                    b.Property<string>("CatalogID")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasAnnotation("Relational:JsonPropertyName", "catalog");
