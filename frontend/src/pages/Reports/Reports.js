  ...
  const fetchReportData = useCallback(async () => {
    ...
    try {
      ...
      const customerData = Object.entries(groupedCustomers)
        .map(([customer, totalInvoices]) => ({ customer, totalInvoices }))
        ...
        <div id="report-sections">
          ...
          <StatsGrid>
            ...
            <StatCard>
              <h3>Thuốc đã bán</h3>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={medicineStats} layout="vertical" margin={{ left: 34, right: 24 }}>
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis type="number" allowDecimals={false} />
                  <YAxis dataKey="medicineName" type="category" width={170} interval={0} />
                  <Tooltip />
